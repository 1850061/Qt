...
"QToolButton:hover { background-color: rgb(50, 50, 50,255);}"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label->setText(QCoreApplication::translate("Widget", "Nothing is impossible\357\274\201", nullptr));
        label_2->setText(QCoreApplication::translate("Widget", "\347\210\261\344\270\212\345\260\217\350\220\214\345\245\263", nullptr));
#if QT_CONFIG(tooltip)
